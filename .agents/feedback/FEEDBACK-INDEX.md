...
反馈条目索引。occurrence ≥3 = 毕业候选（evolution-engine 评估机制化或进规则）。条目格式见 `harness/templates/Feedback-Template.md`；新条目由 feedback-writer skill 写入。
...
| main-agent-no-direct-coding | 主 Agent 只编排不编码 | 3 | 已进宪法：纪律 3 |
